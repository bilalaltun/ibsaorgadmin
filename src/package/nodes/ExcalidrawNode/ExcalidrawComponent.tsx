...
// @ts-expect-error: AppState and BinaryFiles are not exported explicitly, workaround for internal usage
import { AppState, BinaryFiles } from "@excalidraw/excalidraw";
