...
// @ts-expect-error: accessing internal type definitions from Excalidraw
import { Excalidraw, AppState, BinaryFiles, ExcalidrawImperativeAPI, ExcalidrawInitialDataState, ExcalidrawElement} from "@excalidraw/excalidraw";
...
export default function ExcalidrawModal({
  ...
  const save = () => {
    if (elements && elements.filter((el: { isDeleted: ExcalidrawElement; }) => !el.isDeleted).length > 0) {
